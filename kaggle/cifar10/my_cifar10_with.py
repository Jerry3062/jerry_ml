...
history = model.fit(x_train, y_train, 256, 60, validation_data=(x_test, y_test), verbose=2,shuffle=True)
plt.plot()
...
file.write('\nepochs %d sec_cost %.2f model c32-b-c64-b-m-d25---c128-b-c256-b-m-d25---c256-b-c256-b-m-d25---f512-f512-d50\n' % (\
